...
**[Headless configuration of Lantern](items/headless-config.md)** - To enable users to more easily set up their own 
fallback servers we should let users login to their google account through the command line.
